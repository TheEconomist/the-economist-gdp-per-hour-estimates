...
GDP adjusted for hours worked (and costs) were estimated by adjusting GDP PPP in a given country by the ratio of their hours worked to the average for the world as a whole (i.e. mean of all countries, weighted by population). 
